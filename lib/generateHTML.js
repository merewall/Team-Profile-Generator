...
<html lang="en">
    ...
    <head>
        ...
        <!-- Favicon -->
        <link rel="icon" type="image/png" href="https://static.thenounproject.com/png/58999-200.png">
    ...
    <body>
        ...
        <nav>
            <div class="nav-wrapper" id="nav-wrapper">
                <h1 class="center">My Team</h1><span><i class="material-icons" style="font-size: 4.2rem;">&nbsp;&nbsp;people</i></span>
            </div>
        </nav>
